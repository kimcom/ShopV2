...
public class ReportPriceSticker extends JDialog{
...
//System.out.println(""+i+" "+c.getWidth() + " " + c.getHeight());
    ...
    public ReportPriceSticker(BigDecimal docID, int type, int countStickers) {
		try {
	...
	private void fillCheck(){
		...
		ResultSet res;
		if (type == 0){
			res = cnn.getStickerReport(currentDocID,"5158");//стикеры
		} else {
...
//					jLabel14.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(128, 128, 128)));
					...
					jPanel1.add(jLabel11, new org.netbeans.lib.awtextra.AbsoluteConstraints(x, y + 3, width_out - padding_right, height_label));
