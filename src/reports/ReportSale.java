...
public class ReportSale extends JDialog implements Printable{
...
//		System.out.println("page: "+Integer.toString(pageNumber));
    ...
    public ReportSale(int division) {
    ...
    private void clientInfo() {
        ...
        setTitle("Отчет о продажах. ".concat(conf.FORM_TITLE));
        ...
        jLabel6.setText("ОТЧЕТ О ПРОДАЖАХ       ("+MyUtil.getClientID()+")");
    ...
    private void fillCheck(){
        ...
        ResultSet res = cnn.getSaleReport(division);
        //return rs;
        int y = 0, h;
        try {
            while (res.next()) {
...
//				jLabel13.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 0, 0)));
				...
				//название
				h = 11;
                String str = res.getString("Notes").toString();
                int max = 30;
				...
				String strQuantity = "";
				if (bdSumma != null) 
					strSumma = bdSumma.setScale(2, RoundingMode.HALF_UP).toPlainString();
				if (bdQuantity != null) {
					strQuantity = bdQuantity.toPlainString();
					jLabel11.setFont(new java.awt.Font("Tahoma", 0, 8)); // NOI18N
					jLabel13.setFont(new java.awt.Font("Tahoma", 0, 9)); // NOI18N
				} else {
				...
				jPanel2.add(jLabel11, new org.netbeans.lib.awtextra.AbsoluteConstraints(15, y, 120, h));

				if (str.startsWith("ИТОГО")){
					//сумма
					jLabel13.setHorizontalAlignment(javax.swing.SwingConstants.RIGHT);
					jLabel13.setText(strSumma);
					jPanel2.add(jLabel13, new org.netbeans.lib.awtextra.AbsoluteConstraints(135, y, 65, h));
				}else{
					//количество
					jLabel12.setHorizontalAlignment(javax.swing.SwingConstants.RIGHT);
					jLabel12.setText(strQuantity);
					jPanel2.add(jLabel12, new org.netbeans.lib.awtextra.AbsoluteConstraints(135, y, 25, h));
					//сумма
					jLabel13.setHorizontalAlignment(javax.swing.SwingConstants.RIGHT);
					jLabel13.setText(strSumma);
					jPanel2.add(jLabel13, new org.netbeans.lib.awtextra.AbsoluteConstraints(160, y, 40, h));
				}
                y = y + h;
    ...
    private void initComponents() {
        ...
        jLabel6.setText("Отчет по кассе");
