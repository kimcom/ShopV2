...
public class ReportCash extends JDialog implements Printable{
...
//		System.out.println("page: "+Integer.toString(pageNumber));
    ...
    private void clientInfo() {
        ...
        setTitle("Отчет по кассе. ".concat(conf.FORM_TITLE));
        ...
        jLabel6.setText("ОТЧЕТ ПО КАССЕ       ("+MyUtil.getClientID()+")");
...
//        jLabel27.setText(cnn.checkSum.toString());
    ...
    private void fillCheck(){
        ...
        ResultSet res = cnn.getCashReport();
        //return rs;
        int y = 0;
        try {
            while (res.next()) {
...
//                jPanel2.add(jLabel13, new org.netbeans.lib.awtextra.AbsoluteConstraints(140, y, 60, 15));
//
                y = y + 15;
