...
import tablemodel.TmOrderGoods;
import tablemodel.TmTree;

public class FrmOrderEdit extends javax.swing.JDialog {
    ...
    public FrmOrderEdit(BigDecimal docID) {
        this.docID = docID;
        initComponents();
...
//                System.out.println("Selection event: " + tp.getLastPathComponent() + " myNode.nodeID: " + Integer.toString(myNode.nodeID));
    ...
    private void requeryGoodsList(int nodeID) {
        ...
        jTableGoodsList.setModel(new TmOrderGoods(getGoodsListRS(nodeID)));
    ...
    private void requeryOrderContent() {
        ...
        jTableOrderContent.setModel(new TmOrderContent(getGoodsDocRS()));
