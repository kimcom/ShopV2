		...
		position: $("#position").val(),
            ...
            if ($("#password").val()!=''){
                if ($("#password_new1").val()==$("#password_new2").val()){
                    $("#dialog>#text").html("Пароль успешно сохранен.");
                    $("#dialog").dialog("open");
//                    $.post('../engine/user_save_pass', {
//                        userid: $("#userID").html(),
...
//                    }, "json");
                    ...
                    $("#dialog>#text").html("Ошибка при сохранении пароля!");
                    $("#dialog").dialog("open");
                }
            }
            });
        ...
        <div class="active tab-pane min530 m0 w100p ui-corner-all borderTop1 borderColor frameL border1" id="tab_filter">
            <div class='p5 ui-corner-all frameL border0 w400' style='display1:table;'>
                ...
                <div class="input-group input-group-sm w100p">
                    ...
                    <span id="login" name="login" class="input-group-addon form-control TAL"><?php echo $row['Login']; ?></span>                   
                    <span class="input-group-addon w20p"></span>
                </div>
                <div class="input-group input-group-sm w100p">
                ...
                <div class="input-group input-group-sm w100p">
                    ...
                    <input id="password" name="password" type="text" class="form-control TAL" placeholder="Пароль" value="">
                    <span class="input-group-addon w20p"></span>
                </div>
               <div class="input-group input-group-sm w100p">
                    <span class="input-group-addon w25p TAL">Новый пароль</span>
                    <input id="password_new1" name="password_new1" type="text" class="form-control TAL" placeholder="Новый пароль" value="">
                    <span class="input-group-addon w20p"></span>
                </div>
                <div class="input-group input-group-sm w100p">
                    <span class="input-group-addon w25p TAL">Повторите пароль</span>
                    <input id="password_new2" name="password_new2" type="text" class="form-control" placeholder="Повторите пароль" TAL value="">
                    <span class="input-group-addon w20p"></span>
                </div>
                <div class="input-group input-group-sm w100p">
