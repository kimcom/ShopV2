...
// Creating grid1
	$("#grid1").jqGrid({
		sortable: true,
		url:"../engine/jqgrid3?action=check_list&cl.ClientID=2010&grouping=cl.CheckId&f1=CheckID&f2=CheckStatus&f3=TypePayment&f4=CreateDateTime&f5=City&f6=ClientName&f7=SumBase&f8=SumDiscount&f9=Sum&f10=CardID",
		datatype: "json",
		height:'auto',
		colNames:['№ чека','Статус Чека','Тип оплаты','Дата, время','Город','Магазин','Сумма общая','Сумма скидки','Сумма к оплате','Номер Дисконта'],
		colModel:[
