	...
	$("#grid1").jqGrid({
	    ...
	    colModel: [
			{name: 'pr_ProjectID',	index: 'pr.ProjectID',	width:  40, align: "center",sorttype: "text", search: true},
	   		{name: 'pr_Status',		index: 'pr.Status',		width: 120, align: "left",  stype:'select', searchoptions:{value:":любой;0:можно начинать;20:постановка задач;30:в работе;50:пауза;60:на проверке;100:завершено"}},
