	...
	$("#grid1").jqGrid({
	    ...
	    colModel: [
			{name: 'pc_TaskID',		index: 'pc.TaskID',		width:  40, align: "center",sorttype: "text", search: true},
	   		{name: 'pc_Status',		index: 'pc.Status',		width: 120, align: "left",stype:'select', editoptions: {value: ":любой;0:можно начинать;20:ожидаем зависимость;30:в работе;50:пауза;60:на проверке;100:завершено"}},
