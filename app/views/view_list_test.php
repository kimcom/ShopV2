...
// Creating grid1
	$("#grid1").jqGrid({
		sortable: true,
		url:"../engine/jqgrid3?action=goods_list_w_cost&f1=CardID&f2=Name&f3=DateOfIssue&f4=DateOfCancellation&f5=ClientID&f6=PercentOfDiscount&f7=AmountOfBuying&f8=SummaAmount",	
		datatype: "json",
		height:'auto',
...
//	    }
	...
	$("#grid1").navButtonAdd('#grid1_toppager', {
		...
		onClickButton: function () {
		    ...
		    if (id != '')
				window.location = "../engine/map_discountcard_edit?cardid=" + id;
		}
    });
